# 05 · Expenses & Cost of Ownership

Feature **folder** (never a package). Product spec:
`docs/features/05-expenses-cost-ownership.md`.
...
Scaffold with `/scaffold-feature-module 05 expenses-cost-ownership`. Implemented in its
