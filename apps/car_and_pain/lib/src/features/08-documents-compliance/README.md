# 08 · Documents, Glovebox & Compliance

Feature **folder** (never a package). Product spec:
`docs/features/08-documents-compliance.md`.
...
Scaffold with `/scaffold-feature-module 08 documents-compliance`. Implemented in its
