# 12 · Modifications & Build Log

Feature **folder** (never a package). Product spec:
`docs/features/12-modifications-build-log.md`.
...
Scaffold with `/scaffold-feature-module 12 modifications-build-log`. Implemented in its
