# 13 · Cross-Border, Travel & Emission Zones

Feature **folder** (never a package). Product spec:
`docs/features/13-cross-border-travel.md`.
...
Scaffold with `/scaffold-feature-module 13 cross-border-travel`. Implemented in its
