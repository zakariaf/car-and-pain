# 16 · Components, Batteries, Keys & Consumables

Feature **folder** (never a package). Product spec:
`docs/features/16-components-consumables.md`.
...
Scaffold with `/scaffold-feature-module 16 components-consumables`. Implemented in its
