# 17 · Dashboard, Statistics & Reports

Feature **folder** (never a package). Product spec:
`docs/features/17-dashboard-statistics-reports.md`.
...
Scaffold with `/scaffold-feature-module 17 dashboard-statistics-reports`. Implemented in its
