# 18 · Data, Offline, Backup & Portability

Feature **folder** (never a package). Product spec:
`docs/features/18-data-offline-backup.md`.
...
Scaffold with `/scaffold-feature-module 18 data-offline-backup`. Implemented in its
