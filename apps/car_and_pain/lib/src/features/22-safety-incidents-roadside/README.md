# 22 · Safety, Incidents & Roadside

Feature **folder** (never a package). Product spec:
`docs/features/22-safety-incidents-roadside.md`.
...
Scaffold with `/scaffold-feature-module 22 safety-incidents-roadside`. Implemented in its
