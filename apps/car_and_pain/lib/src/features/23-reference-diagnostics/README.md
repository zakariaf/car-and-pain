# 23 · Reference, Diagnostics & Recalls

Feature **folder** (never a package). Product spec:
`docs/features/23-reference-diagnostics.md`.
...
Scaffold with `/scaffold-feature-module 23 reference-diagnostics`. Implemented in its
